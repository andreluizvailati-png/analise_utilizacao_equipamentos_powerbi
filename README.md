...
## 📌 Objetivo
Desenvolver um dashboard em Power BI para análise da utilização de equipamentos, permitindo identificar eficiência operacional, ociosidade e padrões de uso ao longo do tempo.
